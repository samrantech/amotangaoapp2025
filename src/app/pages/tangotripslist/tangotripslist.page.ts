...
@Component({
  ...
  templateUrl: './tangotripslist.page.html',
  styleUrls: ['./tangotripslist.page.scss'],
})
export class EventlistPage implements OnInit {
 ...
 ngOnInit() {
  ...
  fngetpagesdata(){
    ...
    this.objCourserv.gettangotrips(loguserdata).subscribe(
      (data:any) => {
...
onLoadTripsItems(itemdata) {    
  let navextra: NavigationExtras = { state: { wkgroupid: itemdata.id } };
  this.route.navigateByUrl('/tangotripsitems', navextra);
}
