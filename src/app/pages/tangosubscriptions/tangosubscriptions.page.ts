...
@Component({
  selector: 'app-tangosubscriptions',
  templateUrl: './tangosubscriptions.page.html',
  styleUrls: ['./tangosubscriptions.page.scss'],
})
export class TangosubscriptionsPage implements OnInit {
